...
import { Menu } from '..';
import useControlled from '@components/core/src/hooks/useControlled';
...
const SelectInput = React.forwardRef<HTMLInputElement, any>(
  function SelectInput(props, ref?) {
    ...
    const makeHandleItemClick = (child: React.ReactElement) => (event: React.MouseEvent<HTMLDivElement>) => {
